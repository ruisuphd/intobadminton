...
const PRECACHE_URLS = [
  ...
  // Homepage featured six — regenerated by scripts/generate-home-featured.mjs
  // from the most recently updated articles, so this block moves whenever a
  // content batch lands. Keep it in sync with src/lib/pwa-precache-paths.ts.
  "/review/kawasaki-kace-shoes-review/",
