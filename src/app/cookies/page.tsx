...
export const metadata: Metadata = {
  ...
  description:
    "IntoBadminton Cookie Policy: what cookies and local storage categories we use, default consent state, third parties involved, and how to change your choices at any time.",
