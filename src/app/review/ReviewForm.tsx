...
export function ReviewForm() {
  ...
  return (
    <form
      onSubmit={submit}
      className="mt-8 max-w-2xl space-y-6 rounded-2xl border border-zinc-200 bg-[var(--surface)] p-6 dark:border-zinc-700"
    >
      ...
      <div className="rounded-2xl border border-zinc-200 p-4 text-sm text-[var(--color-muted)] dark:border-zinc-700">
      ...
      <div className="flex flex-wrap gap-3 border-t border-zinc-200 pt-5 dark:border-zinc-700">
        <button
          type="button"
