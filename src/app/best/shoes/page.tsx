...
export const metadata: Metadata = {
  title: "Best badminton shoes (2026 picks)",
  description:
    "Six badminton shoes ranked by stability, cushioning, fit width, and weight feel — for narrow, medium, and wide feet. Picks for club, tournament, and recovering ankles.",
