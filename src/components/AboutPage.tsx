...
const copyEn: Copy = {
  ...
  editorialPrinciples: [
    ...
    },
    {
      ...
      body: "Display ads and affiliate retailer links must be labelled and cannot silently override the fit score. The score is the score; sponsorship is sponsorship.",
    },
  ],
