...
export const sourceReviewArticles = [
  ...
  }),
  {
    ...
    sections: [
      ...
      { heading: "Gen 1: the original Thunder 100 identity", body: "AxForce 100 Gen 1 launched in April 2023 as Li-Ning's most demanding amateur attack racket. Stiff shaft, head-heavy, punishing sweet spot. The reward: when driven cleanly, the original 100 delivers some of the most decisive smashes available. The cost: high entry threshold, fatigue over long sessions, unforgiving mishits." },
  ...
  }),
  {
    ...
    sections: [
      ...
      { heading: "If you came here looking for Anders Antonsen's racket", body: "Antonsen plays the Victor Auraspeed 99 J (Hayabusa). The Victor and Yonex flagship attack philosophies are different enough that no Yonex frame is a direct substitute, so cross-shopping with the 100ZZ Kurenai or VA only makes sense if your buying decision is platform-first rather than player-first." },
    ],
  ...
  },
  {
    ...
    dek: "DriveX 12 in standard Original colourway plays the family's baseline character. The ZSW (Zheng Si Wei signature) plays slightly different — and the difference matters more than the price gap suggests.",
    sections: [
      { heading: "What ZSW stands for", body: "ZSW = 郑思维 (Zheng Si Wei), the Chinese men's doubles player and BWF World Championships and Olympic medallist. Victor's DriveX 12 ZSW J is his signature build. (Lee Zii Jia is a separate Victor athlete — Malaysian men's singles — with different signature equipment.)" },
