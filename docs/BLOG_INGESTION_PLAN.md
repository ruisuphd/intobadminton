...
| 11 | `中羽球友-chengzhen-对「ASTROX-100ZZ.md` | Astrox 100ZZ Anders Antonsen Edition | Yonex | review | — | Partial (`Astrox 100ZZ` + `Astrox 100ZZ VA` listed; Anders Antonsen edition NOT) | Partial — `yonex-astrox-100zz-axelsen-va-vs-kurenai` exists | 2 | `yonex-astrox-100zz-anders-antonsen-vs-va-vs-kurenai` | Distinct colourway with new frame material (Volume Cut Resin vs Black Micro Core). |
...
3. **`yonex-astrox-100zz-anders-antonsen-vs-va-vs-kurenai`** (file #11) — Astrox 100ZZ is a top-3 search term in Yonex; the Anders Antonsen edition completes the colourway trio alongside the existing Axelsen/Kurenai article.
...
- **Yonex Astrox 100ZZ Anders Antonsen Edition** (distinct from VA / Kurenai variants) — file #11
