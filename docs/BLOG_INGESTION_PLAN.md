...
| 11 | `中羽球友-chengzhen-对「ASTROX-100ZZ.md` | Astrox 100ZZ VA (Viktor Axelsen edition) vs Kurenai | Yonex | review | — | Y (`Astrox 100ZZ` + `Astrox 100ZZ VA`) | Y — `yonex-astrox-100zz-axelsen-va-vs-kurenai` + correction slug `yonex-astrox-100zz-anders-antonsen-vs-va-vs-kurenai` | n/a | Already published | Earlier draft mis-translated 安塞龙 (Viktor Axelsen) as "Anders Antonsen" and created a duplicate article. Rewritten 2026-05-21 as a correction article (slug preserved for SEO continuity — captures search traffic looking for the non-existent Antonsen edition and routes them to the real Kurenai vs VA comparison + Victor Auraspeed 99 J reference). |
...
3. **`yonex-astrox-100zz-anders-antonsen-vs-va-vs-kurenai`** (file #11) — Rewritten 2026-05-21 as a correction article. Slug preserved so search traffic landing on the misattribution gets routed to the real Kurenai vs VA comparison and pointed to Anders Antonsen's actual Victor Auraspeed 99 J (Hayabusa).
...
<!-- "Yonex Astrox 100ZZ Anders Antonsen Edition" was NOT added to products.json as originally planned — Anders Antonsen is a Victor athlete; 安塞龙 = Viktor Axelsen. The VA edition lives in products.json as yy-astrox-100zz-va. The blog article at slug yonex-astrox-100zz-anders-antonsen-vs-va-vs-kurenai was rewritten as a correction article that captures search traffic and explains the naming confusion. -->
