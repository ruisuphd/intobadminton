...
| **Wirecutter / TW** | Retention funnel (saved, compare, guides hub) in CWV set | ✅ `/guides/`, `/saved/`, `/compare/` in crux-template + offline recovery + lighthouse baseline |
...
| 5 | **Retention funnel missing from CrUX** | Guides hub, saved shortlist, compare tray absent from CWV/offline recovery | ✅ 3 new CrUX paths (+ offline recovery + lighthouse baseline) |
...
| 7 | CrUX template includes `/guides/`, `/saved/`, `/compare/` | ✅ |
...
| CrUX-priority non-home paths | 41 (+3 guides hub, saved, compare) |
