...
**Sprint 121 addendum:** Trust-path e2e expansion + consent/transparency CrUX expansion — ✅ trust-path e2e 9→14; `minE2eGuards: 14` on trust-path baseline; `/cookies/` + `/security/` + `/privacy-choices/` + `/research/` + `/updates/` in `crux-template.csv`, offline recovery, lighthouse baseline.
