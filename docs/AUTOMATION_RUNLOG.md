...
**Trigger:** PR #84 merged without homepage bundle slimming; rebased on latest `main` (#110, #117).
...
- Retains main: hero `SiteSearchForm`, `profileToResultsPath`, notify-me migrate/sync, CLS warn in Lighthouse

### Verification

- `npm test` — pending this run
- Lighthouse homepage performance ≥ 0.9 (CI gate)
