...
**Trigger:** GitHub pull request #130 (`ready_for_review`) — Sprint 6 claims registry. Rebased onto latest `main` (includes #135 review search excerpts), shipped `/data/`, string feel guide, `/updates/`.
